...
class raus_systsem_test():
    ...
    def main_data_platform(self): 
        ...
        # check_q = initial_q + [0, 0, 0, 0, 0, - np.pi / 2]
        # self._ptp_exp.move_joint(check_q, qd_limits=self._qd_limit_input)
        print("Initial end effector: ", self._robot.kinematics.forward(initial_q))
        print("Maybe next is: ", joint_xyz_robot_np[0, :])

        # self._robot.kinematics.inverse_nearest(T_ee_moved, initial_q)
...
#         # ========= 4️⃣ Initialize robot and rotate 90° =========
